...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/blazarium-cli.cpp \
           src/blazarium-tx.cpp \
           src/blazarium.cpp \
           src/db.cpp \
           ...
           src/qt/blazarium.cpp \
           src/qt/blazariumstrings.cpp \
...
RESOURCES += src/qt/blazarium.qrc src/qt/blazarium_locale.qrc

TRANSLATIONS += src/qt/locale/blazarium_bg.ts \
                src/qt/locale/blazarium_de.ts \
                src/qt/locale/blazarium_en.ts \
                src/qt/locale/blazarium_es.ts \
                src/qt/locale/blazarium_fi.ts \
                src/qt/locale/blazarium_fr.ts \
                src/qt/locale/blazarium_it.ts \
                src/qt/locale/blazarium_ja.ts \
                src/qt/locale/blazarium_pl.ts \
                src/qt/locale/blazarium_pt.ts \
                src/qt/locale/blazarium_ru.ts \
                src/qt/locale/blazarium_sk.ts \
                src/qt/locale/blazarium_sv.ts \
                src/qt/locale/blazarium_vi.ts \
                src/qt/locale/blazarium_zh_CN.ts \
                src/qt/locale/blazarium_zh_TW.ts
