...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Blazarium Core blazarium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blazarium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blazarium transaction") + "\n" +
                               "  blazarium-tx [options] -create [commands]   " + _("Create hex-encoded blazarium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blazarium transaction
