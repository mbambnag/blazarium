...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000009b804f3b9906e5a1d11bb830c11108e44a7f7e76198a1fc23b8e801b229"));
;
...
public:
	...
	nMasternodeColleteralLimxDev = 1000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Blazarium cryptocurrency";
	...
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        vSeeds.push_back(CDNSSeedData("s1.blazarium.site", "s1.blazarium.site"));
        vSeeds.push_back(CDNSSeedData("s2.blazarium.site", "s2.blazarium.site"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Blazarium BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Blazarium BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Blazarium BIP44 coin type is '1' (All coin's testnet default)
