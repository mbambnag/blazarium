                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Blazarium-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Blazarium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blazarium: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Blazarium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Blazarium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Blazarium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Blazarium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Blazarium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Blazarium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Blazarium Core help message to get a list with possible Blazarium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Blazarium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Blazarium network", "", count));
}
...
{
    QString strTitle = tr("Blazarium Core"); // default title
