...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Blazarium Core"),
     ...
     * override -datadir in the blazarium.conf file in the default data directory
     * (to be consistent with blazariumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
