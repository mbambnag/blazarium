...
/** Utility functions used by the BZM Qt UI.
 */
namespace GUIUtil
{
...
// Render BZM addresses in monospace font
...
// Parse "blazarium:" URI into recipient object, return true on successful parsing
