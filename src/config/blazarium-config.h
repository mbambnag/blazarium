/* src/config/blazarium-config.h.  Generated from blazarium-config.h.in by configure.  */
/* src/config/blazarium-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://blazarium.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Blazarium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Blazarium Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blazarium"
